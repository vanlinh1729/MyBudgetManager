        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    Id = table.Column<Guid>(type: "uniqueidentifier", nullable: false),
                    Name = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    RoleBitMask = table.Column<int>(type: "int", nullable: false),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_GroupBalances", x => x.Id);
                    table.ForeignKey(
                        name: "FK_GroupBalances_Groups_GroupId",
                        column: x => x.GroupId,
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    BitValue = table.Column<int>(type: "int", nullable: false),
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    GroupBalanceId = table.Column<Guid>(type: "uniqueidentifier", nullable: true),
                    CreatedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    Created = table.Column<DateTime>(type: "datetime2", nullable: false),
                    LastModifiedBy = table.Column<string>(type: "nvarchar(max)", nullable: false),
                    LastModified = table.Column<DateTime>(type: "datetime2", nullable: true)
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Categories_GroupBalances_GroupBalanceId",
                        column: x => x.GroupBalanceId,
                        principalTable: "GroupBalances",
                        principalColumn: "Id");
                    table.ForeignKey(
                        name: "FK_Categories_UserBalances_UserBalanceId",
            ...
            migrationBuilder.CreateIndex(
                name: "IX_Categories_GroupBalanceId",
                table: "Categories",
                column: "GroupBalanceId");

            migrationBuilder.CreateIndex(
                name: "IX_Categories_UserBalanceId",
                table: "Categories",
                column: "UserBalanceId");

            migrationBuilder.CreateIndex(
                name: "IX_GroupBalances_GroupId",
                table: "GroupBalances",
                column: "GroupId");
